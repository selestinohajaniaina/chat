...
<section class="bg-gray-50">
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      ...
      <div class="w-full bg-white rounded-lg shadow-xl border-2 md:mt-0 sm:max-w-md xl:p-0 ">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" method="get">
                  ...
                  Do you have an account? <a href="../sigin" class="font-medium text-primary-600 hover:underline">Login</a>
                  </p>
