    ...
    <div class="m-3 w-fit">
        <?php
                ...
                <?php
                    ...
                    if(empty($fetchpdp["photo"])){
                        ...
                        ?>
                            ...
                            <div class="rounded-3xl  font-mono font-bold text-3xl text-slate-700 bg-yellow-200 w-12 h-12 flex justify-center items-center border-solid border-4 border-gray-200"><?=strtoupper($nameUserPost[0])?></div>
            ...
            ?>
                ...
                <!-- liste des commentaires depuis db -->
            <?php
                require('comments/liste.php')
            ?>
