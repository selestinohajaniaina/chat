<div class="flex flex-no-wrap fixed z-10">
                    <!-- Sidebar starts -->
                    <!-- Remove class [ hidden ] and replace [ sm:flex ] with [ flex ] -->
                    <div style="min-height: 727px" class="w-64 absolute sm:relative bg-indigo-900 shadow md:h-full flex-col justify-between hidden ms:flex">
                        <div>
                            ...
                            <ul class="mt-12">
                                <li class="flex w-full justify-between text-white bg-indigo-800  cursor-pointer items-center py-3 px-8">
                                    <a href="javascript:void(0)" class="flex items-center  rounded focus:outline-none focus:ring-2 focus:ring-white">
                                ...
                                <li class="flex w-full justify-between text-gray-200 hover:text-white hover:bg-indigo-800 cursor-pointer items-center px-8 py-3">
                                    <a href="javascript:void(0)" class="flex items-center  rounded focus:outline-none focus:ring-2 focus:ring-white">
                            ...
                            <div class="flex items-center mt-48 mb-4 px-8">
                                <div class="w-10 h-10 bg-cover rounded-md mr-3">
                                    <img src="https://tuk-cdn.s3.amazonaws.com/assets/components/avatars/a_5.png" alt="display avatar" role="img" class="rounded-full h-full w-full overflow-hidden shadow" />
                                </div>
                                <div>
                                    <p class="text-gray-200 text-sm font-medium">Steve Doe</p>
                                    <p class="text-gray-200 text-xs">View Profile</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="w-64 z-40 absolute sm:relative bg-indigo-900 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out" id="mobile-nav">
                        <button aria-label="open sidebar" id="openSideBar" class="h-10 w-10 bg-indigo-900 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-900" onclick="sidebarHandler(true)">
                            <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/light_with_icons_at_bottom_alternate_style-svg7.svg" alt="toggler">
                        </button>
                        <div id="closeSideBar" class="hidden h-10 w-10 bg-indigo-900 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer text-white" onclick="sidebarHandler(false)">
